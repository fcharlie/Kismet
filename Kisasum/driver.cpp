...
KisasumAlgorithm KisasumAlgorithmResolve(const std::wstring &alg,int &width) {
	...
	std::unordered_map<std::wstring, std::pair<KisasumAlgorithm, int>> algs = {
		{L"md5",{KisasumMD5,0}},
		{L"sha1",{KisasumSHA1,0} },
		{L"sha1dc",{KisasumSHA1DC,0}},
		{L"sha224",{KisasumSHA2,224}},
		{L"sha256",{KisasumSHA2,256}},
		{L"sha384",{KisasumSHA2,384}},
		{L"sha512",{KisasumSHA2,512}},
		{ L"sha3-224",{ KisasumSHA3,224 } },
		{ L"sha3-256",{ KisasumSHA3,256 } },
		{ L"sha3-384",{ KisasumSHA3,384 } },
...
bool KisasumCaclulateElem(bool out,KisasumAlgorithm alm,
	int width,const std::wstring_view &file, KisasumElement &elm) {
	AllocSingle as;
